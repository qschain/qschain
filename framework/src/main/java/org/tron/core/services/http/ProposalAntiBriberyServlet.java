...
@Component
@Slf4j(topic = "API")
public class ProposalAntiBriberyServlet  extends RateLimiterServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            Protocol.Transaction tx = wallet
                    .createTransactionCapsule(build.build(), Protocol.Transaction.Contract.ContractType.ProposalAntiBriberyContract)
                    .getInstance();
